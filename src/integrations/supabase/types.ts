  ...
  public: {
    Tables: {
      ...
      hpm_compliance_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "hpm_compliance_items_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "hpm_companies"
            referencedColumns: ["id"]
      ...
      hpm_kasbon: {
        ...
        Relationships: [
          {
            foreignKeyName: "hpm_kasbon_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "hpm_companies"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "hpm_kasbon_employee_id_fkey"
            columns: ["employee_id"]
            isOneToOne: false
            referencedRelation: "hpm_employees"
            referencedColumns: ["id"]
